...
export default class FormEditPelanggan extends Component {
  constructor(props) {
    super(props);
  ...
  UpdateRecord = () => {
    fetch(
      "https://mposupj.000webhostapp.com/pelanggan/UpdatePelangganRecord.php",
      {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          id_pelanggan: this.state.TextInput_ID,
  ...
  DeleteRecord = () => {
    fetch(
      "https://mposupj.000webhostapp.com/pelanggan/DeletePelangganRecord.php",
      {
        method: "POST",
        headers: {
          Accept: "application/json",
