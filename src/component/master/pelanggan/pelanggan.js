...
export default class Pelanggan extends Component {
  ...
  GetStudentIDFunction = (
    ...
    this.props.navigation.navigate("EditPelanggan", {
      ID: id_pelanggan,
      NAMA: nama_pelanggan,
      ALAMAT: alamat_pelanggan,
      TLP: no_tlp_pelanggan,
    });
  };
  ...
  render() {
    ...
    return (
      <View style={styles.MainContainer_For_Show_StudentList_Activity}>
            ...
            renderRow={(rowData) => (
              <TouchableOpacity
                ...
                onPress={this.GetStudentIDFunction.bind(
                  ...
                  rowData.alamat_pelanggan,
                  rowData.no_tlp_pelanggan
                )}
              >
        ...
        <TouchableOpacity
          onPress={() => this.props.navigation.navigate("CreatePelanggan")}
          style={styles.fab}
        >
